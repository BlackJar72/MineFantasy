...
/*    */ public class RenderBoltMF
/*    */   extends Render
/*    */ {
/*    */   public void renderArrow(EntityBoltMF bolt, double x, double y, double z, float xr, float yr)
/*    */   {
/* 23 */     loadTexture(MFResource.image("/item/Projectile/" + bolt.getTexture() + ".png"));
/* 24 */     GL11.glPushMatrix();
/* 25 */     GL11.glTranslatef((float)x, (float)y, (float)z);
/* 26 */     GL11.glRotatef(bolt.field_70126_B + (bolt.field_70177_z - bolt.field_70126_B) * yr - 90.0F, 0.0F, 1.0F, 0.0F);
/* 27 */     GL11.glRotatef(bolt.field_70127_C + (bolt.field_70125_A - bolt.field_70127_C) * yr, 0.0F, 0.0F, 1.0F);
...
/* 40 */     float var21 = bolt.field_70249_b - yr;
/*    */     
/* 42 */     if (var21 > 0.0F) {
...
/*    */   {
/* 89 */     renderArrow((EntityBoltMF)entity, x, y, z, xr, yr);
/*    */   }
/*    */   
...
/* Location:              /home/jared/bin/JavaDecompiler/MineFantasy-1.4.4.jar!/minefantasy/client/entityrender/RenderBoltMF.class
