...
public class ModelDrake<EntityDrake> extends ModelBiped {
	...
	@Override
	public void setRotationAngles(float limbSwing, float swingAmount, 
		...
		Rthigh.rotateAngleX = Rleg.rotateAngleX 
				= RFoot.rotateAngleX = RToe1.rotateAngleX 
				= RToe2.rotateAngleX = bipedRightLeg.rotateAngleX;
		Lthigh.rotateAngleX = Lleg.rotateAngleX 
				= LFoot.rotateAngleX = LToe1.rotateAngleX 
				= LToe2.rotateAngleX = bipedLeftLeg.rotateAngleX;
